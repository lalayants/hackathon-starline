...
: ${AMENT_CURRENT_PREFIX:="/workspace/src/pointcloud2laserscan/install/hsl"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/hsl/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/hsl/environment/path.sh"
